...
- CORRECTION ORALE : "du lait... non, deux bouteilles de lait" -> garder UNIQUEMENT la version finale (lait, quantite 2, unite bouteilles).
- NÉGATION : "pas besoin de sucre", "finalement non pour le riz" -> ne PAS mettre dans "elements" ; mettre dans "elements_ignores" avec la raison.
